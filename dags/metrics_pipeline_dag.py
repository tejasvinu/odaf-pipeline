...
init_storage = SparkSubmitOperator(
    ...
    conf={
        ...
        # Removing spark.master configuration as it's set in the spark_default connection
    },
...
verify_env = BashOperator(
    ...
    ''',
    env={'JAVA_HOME': '/usr/lib/jvm/java-11-openjdk-amd64', 'PATH': '/home/airflow/.local/bin:/usr/lib/jvm/java-11-openjdk-amd64/bin:${PATH}'},
    dag=dag
)
